    ...
    <div class="col-md-10 bg-white p-4">        <form method="GET">
                @csrf
                ...
                <div id="initialFields" class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input list="keywordsList" name="keyword_1" id="keyword" class="form-control"  multiple req>
                        </div>
                    </div>
                    <div class="col-md-4">
            <div class="form-group">
                <label>Book Barcode</label>
                <select class="mySelect" name="barcode_1[]" multiple="multiple" style="width: 100%" required>
    ...
    function addFields() {
        ...
        subjectField.className = 'col-md-4';
        ...
        keywordFieldContainer.className = 'col-md-4 d-flex align-items-center';
